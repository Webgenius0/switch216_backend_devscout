    ...
    <div class="card bg-white border-0 rounded-3 mb-4">
        <div class="card-body p-4">
            ...
            <div class="mb-4">
                ...
                <p class="fs-15">Add New Subcription Pakage here.</p>
            </div>

            <form action="{{ route('subcription_pakage.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    {{-- Title input feild --}}
                    <div class="col-lg-6">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text"
                                    ...
                                    name="button_text" value="{{ old('button_text') }}" required
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Description here">{{ old('description') }}</textarea>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="d-flex flex-wrap gap-3">
                            <button type="reset" class="btn btn-danger py-2 px-4 fw-medium fs-16 text-white" onclick="window.location.href='{{route('subcription_pakage.index')}}'">Cancel</button>
