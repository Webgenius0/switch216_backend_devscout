...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <h3 class="mb-0">Subcription Pakage List</h3>
                            ...
                            <div class="card bg-white border-0 rounded-3 mb-4">
                                <div class="card-body p-0">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 p-4">
                                        ...
                                        <a href="{{ route('subcription_pakage.create') }}"
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            let dTable = $('#basic_tables').DataTable({
                ...
                ajax: {
                    url: "{{ route('subcription_pakage.index') }}",
                    type: "get"
                },
    ...
    <script>
        ...
        function changeStatus(event, id) {
            ...
            let statusUrl = '{{ route('subcription_pakage.status', ':id') }}';
        ...
        function deleteRecord(event, id) {
            event.preventDefault();
            let deleteUrl = '{{ route('subcription_pakage.destroy', ':id') }}';
