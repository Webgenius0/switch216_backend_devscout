                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text"
                                    ...
                                    name="title" value="{{ old('title', $settings->title ?? 'Switch') }}" required
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text"
                                    ...
                                    name="system_name" value="{{ old('system_name', $settings->system_name ?? 'Switch') }}" required
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text"
                                    ...
                                    name="contact_number" value="{{ old('contact_number', $settings->contact_number ?? '+91-80-65652545') }}" required
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="email"
                                    ...
                                    name="email" value="{{ old('email', $settings->email ?? 'switch@business.com') }}" required
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <input type="text"
                                    ...
                                    name="copyright_text" value="{{ old('copyright_text', $settings->copyright_text ?? '© 2023 Holzbau, All right reserved') }}" required
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-group position-relative">
                                <textarea class="form-control text-dark ps-5 h-55 @error('description') is-invalid @enderror"
                                    ...
                                    placeholder="Enter description here">{{ old('description', $settings->description ?? 'Effortlessly manage and organize chats, tasks, and files in one centeral location with Qoterra chat management solutions.') }}</textarea>
                            </div>
                            @error('description')
