...
@section('content')
    ...
    <main>
        <h2 class="section-title">Add New Dynamic page</h2>
        ...
        <div class="addbooking-form-area">
          <form action="{{ route('dynamic.page.store') }}" method="POST" class="tm-form mt-5" enctype="multipart/form-data">
            @csrf
            ...
            {{-- <button class="tm-dashboard-btn" type="submit" style="align-self: flex-start;">Submit</button> --}}
        </form>
        </div>
    </main>
@endsection
