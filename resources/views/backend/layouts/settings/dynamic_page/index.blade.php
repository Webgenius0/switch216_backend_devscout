            ...
            <div class="card-body p-0">
                ...
                <div class="default-table-area style-two all-products">
                    ...
                    <div class="pagination-wrapper row justify-content-between align-items-center mt-4">
                        <!-- Previous Button -->
                        <a class="prev-page-btn btn btn-light d-flex align-items-center col-auto" href="#" id="prevPage">
                        ...
                        <!-- Next Button -->
                        <a class="next-page-btn btn btn-light d-flex align-items-center col-auto" href="#" id="nextPage">
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateCustomPagination(totalPages, currentPage) {
                ...
                if (startPage > 1) { 
                    paginationContainer.append(`<a href="#" class="badge bg-secondary px-3 py-2" data-page="1">1</a>`);
                    if (startPage > 2) {
