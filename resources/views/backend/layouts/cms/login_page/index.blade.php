            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">Login page </span>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">Video Section</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-xl-12 col-xxl-12 col-lg-12">
                <div class="card bg-white border-0 rounded-3 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            <h4 class="fs-20 mb-1">CMS Login Page Container</h4>
                            <p class="fs-15">Update Login Page Video and site details here.</p>
                        </div>

                        <form action="{{ route('cms.login_page.login_page_video.login_page_video_update') }}" method="POST"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group ">
                                    ...
                                    <input class="dropify form-control @error('image') is-invalid @enderror" type="file"
                                        accept="video/*" name="image"
                                        data-default-file="{{ isset($LoginVideoContainer) && $LoginVideoContainer->image ? asset($LoginVideoContainer->image) : '' }}">
                                    @error('image')
