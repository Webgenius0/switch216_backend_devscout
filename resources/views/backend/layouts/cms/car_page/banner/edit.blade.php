    ...
    <div class="main-content-container overflow-hidden">
        ...
        <div class="card bg-white border-0 rounded-3 mb-4">
            <div class="card-body p-4">
                ...
                <form action="{{ route('cms.car_page.banner.update', $data->id) }}" method="POST"
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label class="label text-secondary mb-1">Backend Image</label>
                            <input class="dropify form-control @error('background_image') is-invalid @enderror" type="file"
                                name="background_image" data-default-file="{{ $data->background_image ? asset($data->background_image) : '' }}">
