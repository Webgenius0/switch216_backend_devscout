...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <h3 class="mb-0">CMS Home Plat Form Work List</h3>
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">CMS Home Plat Form Work</span>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="fw-medium">CMS Home Plat Form Work List</span>
                    </li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-xl-5 col-xxl-5 col-lg-6">
                <div class="card bg-white border-0 rounded-3 mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            <h4 class="fs-20 mb-1">CMS Home Page Plat Form Work Container</h4>
                            <p class="fs-15">Update Home Page Plat Form Work Container and site details here.</p>
                        </div>

                        <form action="{{ route('cms.home_page.platform_work_container.platform_work_container_update') }}"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <input type="text"
                                                ...
                                                name="title" value="{{ old('title', $PlatFormWorkContainer->title ?? '') }}"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="form-group position-relative">
                                            <textarea class="form-control text-dark ps-5 h-55 " name="description" required=""
                                                placeholder="Enter description here">{{ old('description', $PlatFormWorkContainer->description ?? '') }}</textarea>
                                        </div>
                                        @error('sub_title')
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group ">
                                        <label class="label text-secondary mb-1">Video<span
                                                ...
                                                data-default-file="{{ isset($PlatFormWorkContainer) && $PlatFormWorkContainer->image ? asset($PlatFormWorkContainer->image) : '' }}">                                         
                                        @error('image')
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 p-4">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-bs-toggle="modal" data-bs-target="#CreatePlatFormWorkContainer">
        ...
        <x-modal id="EditPlatFormWorkContainer" title="Update" labelledby="customModalLabel" size="modal-lg"
            saveButton="Update">
            <div id="EditPlatFormWorkContainerContent"></div>
        </x-modal>

        {{-- here this return a model  start --}}
        @include('backend.layouts.cms.home_page.platform_work_container.create')
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            let dTable = $('#basic_tables').DataTable({
                ...
                ajax: {
                    url: "{{ route('cms.home_page.platform_work_container.index') }}",
                    type: "get"
                },
                columns: [{
                        data: 'DT_RowIndex',
    ...
    <script>
        ...
        function changeStatus(event, id) {
            ...
            let statusUrl = '{{ route('cms.home_page.platform_work_container.status', ':id') }}';
        ...
        function deleteRecord(event, id) {
            event.preventDefault();
            let deleteUrl = '{{ route('cms.home_page.platform_work_container.destroy', ':id') }}';
    ...
    <script>
        $('#request-form').on('submit', function(event) {
            ...
            let storeurl = '{{ route('cms.home_page.platform_work_container.store') }}';
    ...
    <script>
        function viewModel(id) {
            let url = '{{ route('cms.home_page.platform_work_container.edit', ':id') }}'.replace(':id', id);
            $.ajax({
                type: "GET",
                url: url,
                success: function(resp) {
                    $('#EditPlatFormWorkContainerContent').html(resp);
                    $('#request-form-update').on('submit', function(event) {
                        ...
                        let storeurl =
                            '{{ route('cms.home_page.platform_work_container.update', ':id') }}'
                            .replace(
                                ':id', id);
                        let formData = new FormData(this); // Collect form data
                        $.ajax({
