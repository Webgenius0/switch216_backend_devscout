                 ...
                 @if (Auth::check())
                     <div class="profile-dropdown-container1">
                         ...
                         <div class="profile-dropdown1">
                             <a class="dropdown-item1 mb-2">Mr. John Doe</a>
                             <a href="#">
