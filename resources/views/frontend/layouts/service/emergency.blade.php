    ...
    <main class="container provider-list-container emg-service m-bottom">
        <section>
            ...
            <div class="service-providers mt-4 mt-md-5" data-aos="fade-down">
                <div data-href="./service-provider-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend/assets/images/provider-1.png') }}" alt="" />
                    ...
                    <div class="text-content">
                        ...
                        <a class="action mt-4" href="./service-provider-profile.html">
                ...
                <div data-href="./service-provider-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend/assets') }}/images/provider-2.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./service-provider-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend/assets') }}/images/provider-3.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./service-provider-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend/assets') }}/images/provider-4.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./service-provider-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend/assets') }}/images/provider-5.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
