    ...
    <div class="row">
      <div class="col-md-7 col-lg-8">
        ...
        <div class="profile-header-section">
          <div class="profile-section">
            <figure class="profile-img">
              <img src="./assets/images/profile.jpg" alt="Service provider profile" />
            </figure>
          </div>
              ...
              <span class="media-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                  ...
                  <path
                    ...
                    fill="white" />
                  <defs>
                    <radialGradient id="paint0_radial_4669_326" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                    ...
                    <radialGradient id="paint1_radial_4669_326" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
        ...
        <article class="about-section">
          <h2 class="profile-section-title">About Us</h2>
          <p class="des">
            John Smith is a professional DJ with over 10 years of experience
            providing music and entertainment for weddings, corporate events,
            and private parties. He has a reputation for creating
            unforgettable experiences with a wide range of music styles
            tailored to any audience. Whether it's a wedding or a birthday
            bash, John ensures the party keeps going with his expert DJ
            skills.
          </p>
        </article>
        <!-- about section end -->
        ...
        <div class="gallery-section">
          <div class="gallery-image">
            <figure>
              <img src="./assets/images/gallary-house-1.png" alt="gallery image" />
            </figure>
          </div>
          <div class="gallery-image">
            <figure>
              <img src="./assets/images/gallary-house-2.png" alt="gallery image" />
            </figure>
          </div>
          <div class="gallery-image">
            <figure>
              <img src="./assets/images/gallary-house-3.png" alt="gallery image" />
            </figure>
          </div>
          <div class="gallery-image">
            <figure>
              <img src="./assets/images/gallary-house-4.png" alt="gallery image" />
            </figure>
          </div>
          <div class="gallery-image">
            <figure>
              <img src="./assets/images/gallary-house-5.png" alt="gallery image" />
            </figure>
          </div>
          <div class="gallery-image">
            <figure>
              <img src="./assets/images/gallary-house-6.png" alt="gallery image" />
            </figure>
          </div>
        </div>
        <!-- gallery section end -->
          ...
          <div class="comment-item">
            <div class="comment-header">
              <figure class="comment-user-img">
                <img src="./assets/images/comment-user.jpg" />
              </figure>
              <div class="comment-user-details">
                <h6 class="comment-user-name">Nasir J</h6>
                <div class="comment-ratings">
                  <svg class="full-rating" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                    fill="none">
                    <path
