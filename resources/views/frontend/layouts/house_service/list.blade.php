...
@section('content')
  ...
  <section class="se--home-rental-banner2 se--bottom ">
        ...
        <div class="se--home--rental--search-section ">
          ...
          <div class="se--serach-icon">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="31" height="30" viewBox="0 0 31 30" fill="none">
              ...
              <path d="M21.0547 20.5547L26.7501 26.2501" stroke="white" stroke-width="3" stroke-linecap="round"
  ...
  <main class="container provider-list-container emg-service m-bottom">
    <section>
      <h2 class="section-title">Top house in our city</h2>
      ...
      <div class="filters-container mt-2">
        <fieldset class="filter-input-wrapper">
          <input class="filter-input-field" placeholder="Location" type="text" />
        </fieldset>
        <select class="select">
      ...
      <div class="service-providers mt-4 mt-md-5" data-aos="fade-down">
        <div data-href="./home-details-profile.html" class="item item-link">
          <div class="img-container">
            <img src="./assets/images/home-list-1.png" alt="" />
          ...
          <div class="text-content">
            <div class="heading">
              <div>
                <h4 class="section-card-title">Danial David</h4>
                <div class="location">
            ...
            <p class="section-card-text mt-2 mb-2">
              Professional DJ with 10 years of experience in weddings and
              corporate events.
            </p>
            <a class="action mt-4" href="./home-details-profile.html">
        ...
        <div data-href="./home-details-profile.html" class="item item-link">
          <div class="img-container">
            <img src="./assets/images/home-list-2.png" alt="" />
            <div class="react active">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M16.44 3.1001C14.63 3.1001 13.01 3.9801 12 5.3301C10.99 3.9801 9.37 3.1001 7.56 3.1001C4.49 3.1001 2 5.6001 2 8.6901C2 9.8801 2.19 10.9801 2.52 12.0001C4.1 17.0001 8.97 19.9901 11.38 20.8101C11.72 20.9301 12.28 20.9301 12.62 20.8101C15.03 19.9901 19.9 17.0001 21.48 12.0001C21.81 10.9801 22 9.8801 22 8.6901C22 5.6001 19.51 3.1001 16.44 3.1001Z"
        ...
        <div data-href="./home-details-profile.html" class="item item-link">
          <div class="img-container">
            <img src="./assets/images/home-list-3.png" alt="" />
            <div class="react active">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M16.44 3.1001C14.63 3.1001 13.01 3.9801 12 5.3301C10.99 3.9801 9.37 3.1001 7.56 3.1001C4.49 3.1001 2 5.6001 2 8.6901C2 9.8801 2.19 10.9801 2.52 12.0001C4.1 17.0001 8.97 19.9901 11.38 20.8101C11.72 20.9301 12.28 20.9301 12.62 20.8101C15.03 19.9901 19.9 17.0001 21.48 12.0001C21.81 10.9801 22 9.8801 22 8.6901C22 5.6001 19.51 3.1001 16.44 3.1001Z"
        ...
        <div data-href="./home-details-profile.html" class="item item-link">
          <div class="img-container">
            <img src="./assets/images/home-list-4.png" alt="" />
            <div class="react active">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M16.44 3.1001C14.63 3.1001 13.01 3.9801 12 5.3301C10.99 3.9801 9.37 3.1001 7.56 3.1001C4.49 3.1001 2 5.6001 2 8.6901C2 9.8801 2.19 10.9801 2.52 12.0001C4.1 17.0001 8.97 19.9901 11.38 20.8101C11.72 20.9301 12.28 20.9301 12.62 20.8101C15.03 19.9901 19.9 17.0001 21.48 12.0001C21.81 10.9801 22 9.8801 22 8.6901C22 5.6001 19.51 3.1001 16.44 3.1001Z"
        ...
        <div data-href="./home-details-profile.html" class="item item-link">
          <div class="img-container">
            <img src="./assets/images/home-list-5.png" alt="" />
            <div class="react active">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M16.44 3.1001C14.63 3.1001 13.01 3.9801 12 5.3301C10.99 3.9801 9.37 3.1001 7.56 3.1001C4.49 3.1001 2 5.6001 2 8.6901C2 9.8801 2.19 10.9801 2.52 12.0001C4.1 17.0001 8.97 19.9901 11.38 20.8101C11.72 20.9301 12.28 20.9301 12.62 20.8101C15.03 19.9901 19.9 17.0001 21.48 12.0001C21.81 10.9801 22 9.8801 22 8.6901C22 5.6001 19.51 3.1001 16.44 3.1001Z"
        ...
        <div data-href="./home-details-profile.html" class="item item-link">
          <div class="img-container">
            <img src="./assets/images/home-list-6.png" alt="" />
            <div class="react active">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  d="M16.44 3.1001C14.63 3.1001 13.01 3.9801 12 5.3301C10.99 3.9801 9.37 3.1001 7.56 3.1001C4.49 3.1001 2 5.6001 2 8.6901C2 9.8801 2.19 10.9801 2.52 12.0001C4.1 17.0001 8.97 19.9901 11.38 20.8101C11.72 20.9301 12.28 20.9301 12.62 20.8101C15.03 19.9901 19.9 17.0001 21.48 12.0001C21.81 10.9801 22 9.8801 22 8.6901C22 5.6001 19.51 3.1001 16.44 3.1001Z"
    ...
    <script type="text/javascript">
        ...
        if (searchDate) {
            const picker = new easepick.create({
                element: searchDate,
                css: [
                    './assets/css/plugins/easepick-1.2.1.css',
                    './assets/css/provider-profile-easepick.css',
                ],
                zIndex: 100,
                format: 'DD-MM-YYYY',
            });
