...
@section('content')
    ...
    <section class="se--car-rental-banner se--bottom ">
    ...
    <main class="container provider-list-container emg-service m-bottom">
        <section>
            ...
            <p class="se--common--pera2 se--bottom">Looking for service? <a class="se--link" href="#">click here</a>
            </p>
            ...
            <div class="service-providers mt-4 mt-md-5" data-aos="fade-down">
                <div data-href="./car-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="./assets/images/car-card1.png" alt="" />
                    ...
                    <div class="text-content">
                        <div class="heading">
                            <div>
                                <h4 class="section-card-title">Ferrari</h4>
                                <div class="location">
                        ...
                        <a class="action mt-4" href="./car-profile.html">
                ...
                <div data-href="./car-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="./assets/images/car-card2.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./car-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="./assets/images/card-card3.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./car-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="./assets/images/car-card4.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./car-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="./assets/images/car-card5.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./car-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="./assets/images/car-card-6.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
