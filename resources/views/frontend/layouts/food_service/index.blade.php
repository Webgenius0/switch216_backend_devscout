...
@section('content')
    ...
    <section class="se--food--order--banner se--bottom ">
    ...
    <main class="container provider-list-container emg-service m-bottom">
        <section>
            ...
            <div class="service-providers mt-4 mt-md-5" data-aos="fade-down">
                <div data-href="./food-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend')}}/assets/images/food-card-1.png" alt="" />
                    ...
                    <div class="text-content">
                        <div class="heading">
                            <div>
                                <h4 class="section-card-title">Food</h4>
                                <div class="location">
                        ...
                        <a class="action mt-4" href="./food-profile.html">
                ...
                <div data-href="./food-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend')}}/assets/images/food-card-2.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                ...
                <div data-href="./food-profile.html" class="item item-link">
                    <div class="img-container">
                        <img src="{{ asset('frontend')}}/assets/images/food-card-3.png" alt="" />
                        <div class="react active">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
