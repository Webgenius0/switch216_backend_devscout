                ...
                <div class="se--choose--your-services">
                    ...
                    <div class="se--choose--plane-container">
                        @forelse ($data['restaurantServiceSubCategorys'] as $carServicesSubCategory)
                            <a href="{{ route('service.restaurant_list', ['category' => 'Restaurant', 'subcategory' => $carServicesSubCategory->name,'location' => $locations ?? null]) }}"
            ...
            <div class="container">
                <div class="se--houses--layout" data-aos="fade-down">
                    <div class="se--houses-col--1">
                        <h1 class="se--section--header">Restaurants For You in Hoover</h1>
                        <p class="se--common--pera2">Based on Restaurants recently Posts  
                            {{-- <a class="se--link"
                                href="{{ route('service.restaurant_list') }}">click here</a> --}}
                        </p>

                    </div>
                    <div class="se--homes--container">
                        @forelse ($data['restaurant_service'] as $newCarService)
                            <div class="se--home--card">
                                ...
                                <div class="se--house--card--info">
                                    ...
                                    <p class="se--home--card--details">
                                        {{ $newCarService->user->userAddresses()->first()->location ?? ' ' }}</p>
