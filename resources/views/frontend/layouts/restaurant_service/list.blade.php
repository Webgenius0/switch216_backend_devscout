...
@section('content')
  ...
  <section class="se--car-rental-banner se--bottom " style="background-image: url('{{ asset('frontend/assets/images/foodBanner.png') }}');">
    <div class="provider-banner-content container se--banner-text-width  " data-aos="fade-up">
      <h2 class="banner-title ">
        Find the Best <span>Restaurant Services</span> in City
      </h2>
      <p class="banner-text">
