...
{{-- @vite('resources/css/frontend/service/create_page.css') --}}
<style>
...
{{-- <script src="{{ asset('resources/js/frontend_js/service_create_page.js') }}"></script> --}}
@vite('resources/js/frontend/service/service_create_page.js')
@endpush
