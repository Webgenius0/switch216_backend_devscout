          ...
          <div class="auth-card">
            ...
            <form class="auth-form" method="POST" action="{{ route('password.store') }}">
                    ...
                    <span class="show-eye hide-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
                          ...
                          stroke="#929292" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path
                    ...
                    <span class="hide-eye">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path
                          ...
                          stroke="#929292" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M15.5099 12.7C15.2499 14.11 14.0999 15.26 12.6899 15.52" stroke="#929292"
                          stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M9.47 14.53L2 22" stroke="#929292" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round"></path>
                        <path d="M22 2L14.53 9.47" stroke="#929292" stroke-width="1.5" stroke-linecap="round"
                          stroke-linejoin="round"></path>
                      </svg>
                    </span>
                  </button>
              ...
              <fieldset class="input-wrapper password-wrapper">
                ...
                <div class="icon-input-wrapper">
                  <input class="input-field" type="password" id="userConfirmPassword" placeholder="********" name="password_confirmation" />
                  <button class="pass-show-btn" type="button">
                    <span class="show-eye hide-icon">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path
